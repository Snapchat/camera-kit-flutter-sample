...
1. Once, the project is compiled, navigate to the `iOS` folder and open `Running.xcworkspace` using Xcode. You should see two projects: Runner and Pods
2. Navigate to `Configuration.swift` and enter your app's Camera Kit credentials (Lens Group id, Snap Kit App id, and API Token)
